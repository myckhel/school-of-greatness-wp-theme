...
$activepadding = ($instance['activepadding'] && '' <> $instance['activepadding']) ? (int)$instance['activepadding'] : -45;
...
if ( $testimonial->have_posts() ) {
	$html = '<div class="thim-testimonial-slider layout-slide-2 image-bottom" data-activepadding="' . $activepadding . '" data-ratio="1" data-width="60" data-time="' . $item_time . '" data-visible="' . $item_visible . '" data-auto="' . $autoplay . '" data-mousewheel="' . $mousewheel . '">';
	while ( $testimonial->have_posts() ) : $testimonial->the_post();
        ...
        if( $link_to_single ) {
            ...
            $html .= '<h3 class="title">_' . get_the_title() . ',</h3>';
        }
